...
(async () => {
    ...
    var width = await page.evaluate(() => {return document.body.clientWidth;});
    ...
    if (height > width) { // Return to portrait mode
        ...
        height = await page.evaluate(() => {return document.body.clientHeight;});
        width = await page.evaluate(() => {return document.body.clientWidth;});
    ...
    await page.screenshot({path: "bin/jsdoc/sheets/cheatsheet/" + path + "/" + path + "Sheet.png", fullPage: true, omitBackground: false});
