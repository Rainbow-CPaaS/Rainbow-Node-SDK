...
class Logger {
    ...
    constructor(config, logs) {
        ...
        if(!config.logs) {
            ...
            this._logger.log("info", LOG_ID + "(constructor) don't log dev information in file");
        }
        else {
            ...
            this._logger.log("info", LOG_ID + "(constructor) log dev information in file", config.logs);
        }
    }
