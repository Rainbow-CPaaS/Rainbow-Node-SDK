...
class Events {
    ...
    constructor( _logger, _filterCallback) {
        ...
        this._evReceiver.on("rainbow_onreceipt", function(receipt) {
            ...
            if (receipt.entity === "server") {
                 ...
                 */
                that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onmessageserverreceiptreceived"));
                ...
                if (receipt.event === "received") {
                     ...
                     */
                    that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onmessagereceiptreceived"));
                     ...
                     */
                    that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onmessagereceiptreadreceived"));
        ...
        this._evReceiver.on("rainbow_onmessagereceived", function(message) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onmessagereceived"));
        ...
        this._evReceiver.on("rainbow_onrosterpresencechanged", function(contact) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_oncontactpresencechanged"));
        ...
        this._evReceiver.on("rainbow_onuserinvitereceived", function(invitation) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onuserinvitereceived"));
        ...
        this._evReceiver.on("rainbow_onuserinviteaccepted", function(invitation) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onuserinviteaccepted"));
        ...
        this._evReceiver.on("rainbow_onuserinvitecanceled", function(invitation) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onuserinvitecanceled"));
        ...
        this._evReceiver.on("rainbow_affiliationdetailschanged", function(bubble) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onbubbleaffiliationchanged"));
        ...
        this._evReceiver.on("rainbow_ownaffiliationdetailschanged", function(bubble) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onbubbleownaffiliationchanged"));
        ...
        this._evReceiver.on("rainbow_invitationdetailsreceived", function(bubble) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onbubbleinvitationreceived"));
        ...
        this._evReceiver.on("rainbow_bubblecustomDatachanged", function(bubble) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onbubblecustomdatachanged"));
        ...
        this._evReceiver.on("rainbow_bubbletopicchanged", function(bubble) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onbubbletopicchanged"));
        ...
        this._evReceiver.on("rainbow_bubblenamechanged", function(bubble) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onbubblenamechanged"));
        ...
        this._evReceiver.on("rainbow_ongroupcreated", function(group) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_ongroupcreated"));
        ...
        this._evReceiver.on("rainbow_ongroupdeleted", function(group) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_ongroupdeleted"));
        ...
        this._evReceiver.on("rainbow_ongroupupdated", function(group) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_ongroupupdated"));
        ...
        this._evReceiver.on("rainbow_onuseraddedingroup", function(group, contact) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onuseraddedingroup"));
        ...
        this._evReceiver.on("rainbow_onuserremovedfromgroup", function(group, contact) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onuserremovedfromgroup"));
        ...
        this._evReceiver.on("rainbow_channelmessagereceived", function(message) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onchannelmessagereceived"));
        ...
        this._evReceiver.on("rainbow_onprofilefeatureupdated", function () {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onprofilefeatureupdated"));
        ...
        this._evReceiver.on("rainbow_oncallupdated", function (data) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_oncallupdated"));
        ...
        this._evReceiver.on("rainbow_onvoicemessageupdated", function (data) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onvoicemessageupdated"));
        ...
        this._evReceiver.on("rainbow_oncallforwarded", function (data) {
             ...
             */
            that._logger.log("info", LOG_ID + "publish event " + that._logger.colors.events("rainbow_oncallforwarded"));
    ...
    publish(event, data) {
        ...
        this._logger.log("info", LOG_ID + "(publish) event " + this._logger.colors.events("rainbow_on" + event));
