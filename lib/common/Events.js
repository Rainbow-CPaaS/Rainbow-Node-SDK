...
class Events {
    ...
    constructor( _logger, _filterCallback) {
        ...
        this._evReceiver.on("rainbow_onchannelmessagedeletedreceived", function(message) {
             ...
             *      Fired when a message is received from a channel
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onchannelmessagedeletedreceived"));
            that._evPublisher.emit("rainbow_onchannelmessagedeletedreceived", message);
        });
        ...
        this._evReceiver.on("rainbow_ontelephonystatuschanged", function (data) {
             ...
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_ontelephonystatuschanged"));
            that._evPublisher.emit("rainbow_ontelephonystatuschanged", data);
        });
        ...
        this._evReceiver.on("rainbow_onnomadicstatusevent", function (data) {
             ...
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onnomadicstatusevent"));
            that._evPublisher.emit("rainbow_onnomadicstatusevent", data);
        });
        ...
        this._evReceiver.on("rainbow_filecreated", function (data) {
            /**
             * @event Events#rainbow_filecreated
             * @public
             * @param { data }
             * @description
             *      Fired when a file created event is received
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_filecreated"));
            that._evPublisher.emit("rainbow_filecreated", data);
        });

        this._evReceiver.on("rainbow_fileupdated", function (data) {
            /**
             * @event Events#rainbow_fileupdated
             * @public
             * @param { data }
             * @description
             *      Fired when a file updated event is received
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_fileupdated"));
            that._evPublisher.emit("rainbow_fileupdated", data);
        });

        this._evReceiver.on("rainbow_filedeleted", function (data) {
            /**
             * @event Events#rainbow_filedeleted
             * @public
             * @param { data }
             * @description
             *      Fired when a file deleted event is received
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_filedeleted"));
            that._evPublisher.emit("rainbow_filedeleted", data);
        });

        this._evReceiver.on("rainbow_thumbnailcreated", function (data) {
            /**
             * @event Events#rainbow_thumbnailcreated
             * @public
             * @param { data }
             * @description
             *      Fired when a thumbnail created event is received
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_thumbnailcreated"));
            that._evPublisher.emit("rainbow_thumbnailcreated", data);
        });
        ...
        this._evReceiver.on("rainbow_channelcreated", function (data) {
             ...
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onchannelcreated"));
            that._evPublisher.emit("rainbow_onchannelcreated", data);
        });
        ...
        this._evReceiver.on("rainbow_channeldeleted", function (data) {
             ...
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onchanneldeleted"));
            that._evPublisher.emit("rainbow_onchanneldeleted", data);
        });
    ...
    publish(event, data) {
        ...
        this._logger.log("internal", LOG_ID + "(publish) event " + this._logger.colors.events("rainbow_on" + event) + " : ", info);
