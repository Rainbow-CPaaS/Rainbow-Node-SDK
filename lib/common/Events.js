...
class Events {
    ...
    constructor( _logger, _filterCallback) {
        ...
        this._evReceiver.on("rainbow_filecreated", function (data) {
             ...
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onfilecreated"));
            that._evPublisher.emit("rainbow_onfilecreated", data);
        });
        ...
        this._evReceiver.on("rainbow_fileupdated", function (data) {
             ...
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onfileupdated"));
            that._evPublisher.emit("rainbow_onfileupdated", data);
        });
        ...
        this._evReceiver.on("rainbow_filedeleted", function (data) {
             ...
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onfiledeleted"));
            that._evPublisher.emit("rainbow_onfiledeleted", data);
        });
        ...
        this._evReceiver.on("rainbow_thumbnailcreated", function (data) {
             ...
             */
            that._logger.log("debug", LOG_ID + "publish event " + that._logger.colors.events("rainbow_onthumbnailcreated"));
            that._evPublisher.emit("rainbow_onthumbnailcreated", data);
        });
