...
class Conversation {
    ...
    /*************************************************************/
		...
		static createOneToOneConversation (participant) {
			...
			// TODO ? conversation.filterName = utilService.removeDiacritis(participant.displayName.toLowerCase());
		...
		static createRoomConversation(room) {
			...
			// TODO ? conversation.filterName = utilService.removeDiacritis(room.name.toLowerCase());
