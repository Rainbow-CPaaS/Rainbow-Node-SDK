...
class Contact {
    ...
    updateFromUserData (userData) {
        ...
        if (userData.jid_im) {
            ...
            this.jid_im = userData.jid_im;
            this.jid_tel = userData.jid_tel;
        }
        ...
        this.phonePbx = userData.phonePbx | "";
        ...
        this.roster = this.roster ? this.roster : false;
        this.presence = this.presence ? this.presence : "offline";
                    ...
                    case "work": {
                        if (deviceType === "landline") {
                            ...
                            if (phoneNumber.isFromSystem) {
                                ...
                                if (phoneNumber.internalNumber) { //#29475++
                                    that.phoneInternalNumber = phoneNumber.internalNumber;
                                    if (phoneNumber.deviceName === "Remote extension" || phoneNumber.deviceName === "TERM_ANY_DEVICE") {
