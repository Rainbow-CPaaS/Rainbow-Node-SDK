...
class Logger {
    ...
    constructor(config, logs) {
        ...
        var welcome = () => {
            ...
            this._logger.log("info", LOG_ID + "(constructor) welcome to the Rainbow SDK for Node.js!");
        }
        ...
        if(("logs" in config) && ("enableConsoleLogs" in config.logs) && config.logs.enableConsoleLog) {
        ...
        // Check for file log
        if(("logs" in config) && ("enableFileLogs" in config.logs) && config.logs.enableFileLog) {
            enableFileLog = true;
        } else {
            enableFileLog = false;
        }
        ...
        // Check the directory for logging
