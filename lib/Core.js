...
class Core {
    ...
    constructor(options) {
        ...
        this._fileStorage = new FileStorageService(this._eventEmitter.iee, this.logger);
        ...
        return new Promise(function (resolve, reject) {
            ...
            try {
                ...
                if (!that.options.hasCredentials) {
                    ...
                    that.logger.log("debug", LOG_ID + "(start) start all modules for user : ", that.options.credentials.login);
                    ...
                    return that._stateManager.start().then(() => {
                        ...
                        return that._fileStorage.start(that._xmpp, that._rest);
                    }).then(() => {
