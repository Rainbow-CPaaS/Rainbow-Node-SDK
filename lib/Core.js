...
var getHTTPOptions, getXMPPOptions, getProxyOptions, getIMOptions, getModeOption;
...
class Core {
    ...
    constructor(options, _eventEmitter) {
        ...
        getModeOption = (options) => {

            var mode = config.mode;

            if("rainbow" in options && "mode" in options.rainbow) {
                switch (options.rainbow.mode) {
                    case "xmpp":
                        mode = "xmpp";
                        break;
                    case "hook":
        ...
        this.withXMPP = getModeOption(options) === "xmpp" ? true : false;
            ...
            return new Promise(function(resolve, reject) {
                if(!that.hasCredentials) {
                    ...
                    Promise.all([
                        ...
                        that._xmpp.start(that.withXMPP),
