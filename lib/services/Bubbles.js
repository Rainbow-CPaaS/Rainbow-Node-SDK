...
class Bubbles {
     ...
     * @event
     * @listens module:XMPPService~event:rainbow_invitationreceived
     * @param {Object} invitation contains information about bubble and user's jid
     * @memberof Bubbles
     * @description
     ...
     * @event
     * @listens module:XMPPService~event:rainbow_affiliationchanged
     ...
     * @event
     * @listens module:XMPPService~event:rainbow_ownaffiliationchanged
     * @param {Object} affiliation contains information about bubble and user's jid
     * @memberof Bubbles
     * @description
