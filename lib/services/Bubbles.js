...
class Bubbles {
    ...
    _onAffiliationChanged(affiliation) {
        ...
        this._rest.getBubble(affiliation.bubbleId).then( (bubbleUpdated) => {
            that._logger.log("debug", LOG_ID + "(_onAffiliationChanged) user affiliation changed for bubble", bubbleUpdated.name);
    ...
    _onOwnAffiliationChanged(affiliation) {
        ...
        this._rest.getBubble(affiliation.bubbleId).then( (bubbleUpdated) => {
            that._logger.log("debug", LOG_ID + "(_onOwnAffiliationChanged) affiliation changed for bubble", bubbleUpdated.name);
