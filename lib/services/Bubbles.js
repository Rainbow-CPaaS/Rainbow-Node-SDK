...
class Bubbles {
     ...
     * @async
     * @return {Promise<Bublle>}  return a promise with {Bubble} The bubble found or null
     * @memberof Bubbles
     * @description
    ...
    getBubbleById(id) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            let bubbleFound = that._bubbles.find(function (bubble) {
                return (bubble.id === id);
            });
            ...
            if (bubbleFound) {
                ...
                return that._rest.getBubble(id).then((bubbleFromServer) => {
                    ...
                    if (bubbleFromServer) {
                        ...
                        that._xmpp.sendInitialBubblePresence(bubbleFromServer.jid);
                        resolve(bubble);
                    } else {
                        resolve(null);
                    }
    ...
    getBubbleByJid(jid) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var bubbleFound = that._bubbles.find(function (bubble) {
            ...
            if (bubbleFound) {
                ...
                that._logger.log("debug", LOG_ID + "(getBubbleById) bubble not found in memory, search in server jid : ", jid);
