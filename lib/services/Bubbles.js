    ...
    setBubbleVisibilityStatus(bubble, status) {
        ...
        return new Promise((resolve, reject) => {
            ...
            that._rest.setBubbleVisibility(bubble.id, status).then((bubbleData) => {
                that._logger.log("info", LOG_ID + "(setBubbleVisibilityStatus) customData set", bubbleData);
                resolve(bubbleData);
            }).catch((err) => {
    ...
    setBubbleTopic(bubble, topic) {
        ...
        return new Promise((resolve, reject) => {
            ...
            that._rest.setBubbleTopic(bubble.id, topic).then((bubbleData) => {
                that._logger.log("info", LOG_ID + "(setBubbleTopic) customData set", bubbleData);
                resolve(bubbleData);
            }).catch((err) => {
    ...
    setBubbleName(bubble, name) {
        ...
        return new Promise((resolve, reject) => {
            ...
            that._rest.setBubbleName(bubble.id, name).then((bubbleData) => {
                that._logger.log("info", LOG_ID + "(setBubbleName) customData set", bubbleData);
                resolve(bubbleData);
            }).catch((err) => {
