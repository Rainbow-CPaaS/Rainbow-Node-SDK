...
class Bubbles {
    ...
    deleteBubble(bubble) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if(!bubble) {
                this._logger.log("warn", LOG_ID + "(deleteBubble) bad or empty 'bubble' parameter", bubble);
    ...
    removeContactFromBubble(contact, bubble) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if (!contact) {
                this._logger.log("warn", LOG_ID + "(removeContactFromBubble) bad or empty 'contact' parameter", contact);
                that._logger.log("debug", LOG_ID + "(removeContactFromBubble) _exiting_");
                reject(Error.BAD_REQUEST);
            } else if (!bubble) {
                this._logger.log("warn", LOG_ID + "(removeContactFromBubble) bad or empty 'bubble' parameter", bubble);
                that._logger.log("debug", LOG_ID + "(removeContactFromBubble) _exiting_");
                reject(Error.BAD_REQUEST);
            } else {
