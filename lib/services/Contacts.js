 ...
 * @name Contacts
 * @description
 *       This service manage contact. A contact is defined by a set of public information
 *       (name, firstname, avatar...) and a set of private information.
 */
class Contacts {
        ...
        return new Promise((resolve, reject) => {
             if (!strId) {
                ...
                if (contactFound) {
                    ...
                    that.rest.getContactInformationByID(strId).then((contact) => {
                        that.logger.log("info", LOG_ID + "(getContactById) contact found on the server", contact);
                        resolve(contact);
                    }).catch((err) => {
                        reject(err);
                    });
        ...
        return new Promise((resolve, reject) => {
            if (!strLoginEmail) {
                ...
                if (contactFound) {
                    ...
                    that.logger.log("debug", LOG_ID + "(getContactByLoginEmail) contact not found locally. Ask the server...");
                    that.rest.getContactInformationByLoginEmail(strLoginEmail).then((contact) => {
                        that.logger.log("info", LOG_ID + "(getContactByLoginEmail) contact found on the server", contact);
                        resolve(contact);
                    }).catch((err) => {
                        reject(err);
                    });
     ...
     * @event
     * @listens module:XMPPService~event:rainbow_onrosterpresence
