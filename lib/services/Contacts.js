...
class Contacts {
     ...
     * @return {Contact[]} A promise containing an array with the contact found or an empty array
     * @memberof Contacts
     * @description
    ...
    getContactByLoginEmail(loginEmail) {
        ...
        return new Promise((resolve, reject) => {
            if (!loginEmail) {
                this.logger.log("warn", LOG_ID + "(getContactByLoginEmail) bad or empty 'id' parameter", loginEmail);
                reject(Error.BAD_REQUEST);
            }
            else {
