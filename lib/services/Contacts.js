...
class Contacts {
    ...
    start(_xmpp, _rest) {
        ...
        return new Promise(function(resolve, reject) {
            try {
                ...
                that.logger.log("debug", LOG_ID + "(start) Catch Error !!!", err.message);
                reject();
            }
        });
    }
        ...
        return new Promise((resolve, reject) => {
            that.rest.getContacts().then((listOfContacts) => {
                ...
                listOfContacts.map((contact) => {
                    ...
                    contact.status = "";
                    contact.avatar = that.getAvatarByContactId(contact.id);
                });
    ...
    getOrCreateContact(jid, phoneNumber) {
        ...
        return that.rest.getContactInformationByJID(jid).then( (_contact) => {
            _contact.avatar = that.getAvatarByContactId(_contact.id, contact.lastAvatarUpdateDate);
