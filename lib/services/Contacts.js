...
class Contacts {
    ...
    constructor(_eventEmitter, _logger) {
        ...
        onRosterPresenceChanged = (presence) => {
            ...
            if(contact) {
                ...
                that.logger.log("info", LOG_ID + "onRosterPresenceChanged - Presence changed to " + contact.presence + "|" + contact.status + " for " + contact.displayName);
    ...
    getRosters() {
        ...
        var that = this;
        this.logger.log("debug", LOG_ID + "getRosters - begin");
        return new Promise(function(resolve, reject) {
            ...
            that.eventEmitter.once('rainbow_onrosters', function(jids) {
                that.rest.getContacts(jids).then(function(listOfContacts) {
                    ...
                    that.logger.log("debug", LOG_ID + "getRosters - end");
                    resolve();
                }).catch(function(err) {
     ...
     */
    getAll() {
        this.logger.log("debug", LOG_ID + "getAll - begin/end");
