...
class Contacts {
    ...
    constructor(_eventEmitter, _logger) {
        ...
        onRosterPresenceChanged = (presence) => {
            var contact = that.contacts.find((contactItem) => {
            ...
            if (contact) {
                ...
                that.logger.log("info", LOG_ID + "(onRosterPresenceChanged) presence changed to " + presenceDisplayed + " for " + that.getDisplayName(contact));
    ...
    getRosters() {
        ...
        return new Promise((resolve, reject) => {
            ...
            that.eventEmitter.once("rainbow_onrosters", (jids) => {
                that.rest.getContacts(jids).then((listOfContacts) => {
    ...
    getContactByLoginEmail(strLoginEmail) {
        ...
        return new Promise((resolve, reject) => {
            if (!strLoginEmail) {
                ...
                var contactFound = this.contacts.find((contact) => {
