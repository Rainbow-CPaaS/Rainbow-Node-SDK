 ...
 * @name Presence
 * @description
 *       This service manage the presence of the connected user.
 */
class Presence {
     ...
     * @param {String} strPresence The presence value to set i.e: 'online', 'xa', or 'dnd'
     * @memberof Presence
        ...
        return new Promise((resolve, reject) => {
            ...
            switch (strPresence) {
                ...
                case "invisible":
                    ...
                    break;
                default:
                    that.logger.log("warn", LOG_ID + "(setPresenceTo) Bad or empty 'strPresence' parameter", strPresence);
