    ...
    */
    ...
    holdCall(call) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            that._rest.telephony.holdCall(call).then(
                function success(response) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (activeCall) {
                ...
                /*$http({
                 ...
                 that._rest.telephony.retrieveCall(call).then(
                    function success(response) {
    ...
    transfertCall(activeCall, heldCall) {
        ...
        return new Promise((resolve, reject) => {
            ...
            /*$http({
                ...
                // */
            that._rest.telephony.transfertCall(activeCall, heldCall).then(
                function success() {
    ...
    getForwardStatus() {
        ...
        return new Promise(function (resolve, reject) {
            if (that._contacts.userContact && that._contacts.userContact.phonePbx) {
                ...
                that._rest.telephony.getForwardStatus().then(
                    function success() {
    ...
    sendDtmf(connectionId, dtmf) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (callId && deviceId && dtmf) {
                ...
                that._rest.telephony.sendDtmf(callId, deviceId, data)
                    .then(
                    function success() {
                        resolve();
                    },
