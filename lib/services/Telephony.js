    ...
    getVoiceMessageCounter() {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!that.voiceMailFeatureEnabled) {
                let profileError = new Error("getVoiceMessageCounter failure - Not Allowed");
    ...
    makeSimpleCall(contact, phoneNumber) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!that.isBasicCallAllowed) {
                let profileError = new Error("makeSimpleCall failure - Not Allowed");
                profileError.status = profileError.errorDetailsCode = "403";
            ...
            that._rest.makeCall(contact, phoneInfo).then(
                ...
                function failure(response) {
                    ...
                    that._eventEmitter.emit("rainbow_oncallupdated", call);
                    //$rootScope.$broadcast("ON_CALL_UPDATED_EVENT", call);
                    let error = ErrorCase.CUSTOMERROR(response.code, response.msg, response.details);// errorHelperService.handleError(response);
                    reject(error);
    ...
    makeConsultationCall(contact, phoneNumber, callId) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!that.isSecondCallAllowed) {
                let profileError = new Error("makeConsultationCall failure - Not Allowed");
                profileError.status = profileError.errorDetailsCode = "403";
    ...
    */
    ...
    releaseCall(call) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            //reject not allowed operations
            if (!that.isBasicCallAllowed) {
                let profileError = new Error("releaseCall failure - Not Allowed");
                profileError.status = profileError.errorDetailsCode = "403";
    ...
    answerCall(call) {
        ...
        return new Promise((resolve, reject) => {
            ...
            //reject not allowed operations
            if (!that.isBasicCallAllowed) {
                let profileError = new Error("answerCall failure - Not Allowed");
                profileError.status = profileError.errorDetailsCode = "403";
                that.logger.log("error", LOG_ID + "()[telephonyService] " + profileError.message);
                reject(profileError);
            }
    ...
    holdCall(call) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            //reject not allowed operations
            if (!that.isSecondCallAllowed) {
                let profileError = new Error("holdCall failure - Not Allowed");
                profileError.status = profileError.errorDetailsCode = "403";
    ...
    retrieveCall(call) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            //reject not allowed operations
            if (!that.isSecondCallAllowed) {
                let profileError = new Error("retrieveCall failure - Not Allowed");
                profileError.status = profileError.errorDetailsCode = "403";
    ...
    deflectCallToVM(call) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!that.isVMDeflectCallAllowed) {
                let profileError = new Error("deflectCall failure - Not Allowed");
                profileError.status = profileError.errorDetailsCode = "403";
                that.logger.log("error", LOG_ID + "()[telephonyService] " + profileError.message);
                reject(profileError);
            }
    ...
    transfertCall(activeCall, heldCall) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!that.isTransferAllowed) {
                let profileError = new Error("transferCall failure - Not Allowed");
                profileError.status = profileError.errorDetailsCode = "403";
    ...
    conferenceCall(activeCall, heldCall) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!that.isConferenceAllowed) {
                let profileError = new Error("conferenceCall failure - Not Allowed");
                profileError.status = profileError.errorDetailsCode = "403";
    ...
    forwardToVoicemail() {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!that.voiceMailFeatureEnabled) {
                let profileError = new Error("forwardToVoicemail failure - voicemail feature not enabled");
    ...
    nomadicLogin (phoneNumber, NotTakeIntoAccount) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if (!that.isNomadicEnabled || !that.nomadicObject.featureActivated) {
                let profileError = new Error("nomadicLogin failure - Not Allowed");
                profileError.status = profileError.errorDetailsCode = "403";
                that.logger.log("error", LOG_ID + "[telephonyService] " + profileError.message);
                reject(profileError);
            }
...
// */
    getNomadicStatus () {
        ...
        return new Promise(function(resolve, reject) {
            ...
            //reject not allowed operations
            if (!that.isNomadicEnabled) {
                let error = ErrorCase.CUSTOMERROR("403", "getNomadicStatus failure - Not Allowed", "getNomadicStatus failure - Not Allowed");// errorHelperService.handleError(response);
                reject(error);
            ...
            if (that._contacts.userContact && that._contacts.userContact.phonePbx) {
                ...
                //let error = ErrorCase.ERROR();// errorHelperService.handleError(response);
                let error = new Error("(getNomadicStatus) user logged in pbx info not filled!");
