...
class IM {
    ...
    sendMessageToContact(message, contact, lang, content, subject) {
        ...
        return this.sendMessageToJid(messageUnicode, contact.jid_im, lang, content, subject);
    }
    ...
    sendMessageToBubble(message, bubble, lang, content, subject) {
        ...
        return this.sendMessageToBubbleJid(messageUnicode, bubble.jid, lang, content, subject);
    }
