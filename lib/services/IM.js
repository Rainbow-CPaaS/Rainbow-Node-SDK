...
class IM {
    ...
    getMessageFromBubbleById(bubble, strMessageId) {
        ...
        var conversation = that
            .conversations
            .getConversationByRoomDbId(bubble.dbId);
     ...
     */
    sendMessageToConversation(conversation, strMessage) {

        this
            .logger
            .log("debug", LOG_ID + "[sendMessage] :: Try to send a message...");
        ...
        if (!strMessage) {
            return Promise.reject({code: "ERRORBADREQUEST", label: "Parameter 'strMessage' is missing or empty"});
        }
        ...
        return this
            .conversations
            .sendChatMessage(conversation, strMessage);
    }
