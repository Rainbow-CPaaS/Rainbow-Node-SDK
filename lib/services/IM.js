...
class IM {
     ...
     */
    sendMessageToJid(message, jid, lang, content) {
        if ( !lang) {
            lang = "en";
        }
        ...
        var messageSent = this.xmpp.sendChatMessage(message, jid, lang, content);
     ...
     * @return {Object} The message sent
     */
    sendMessageToBubbleJid(message, jid, lang, content) {
        if ( !lang) {
            lang = "en";
        }
        ...
        var messageSent = this.xmpp.sendChatMessageToBubble(message, jid, lang, content);
