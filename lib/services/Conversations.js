...
class Conversations {
     ...
     * @param {String} conversationId Conversation id The conversation to clean
     ...
     * @instance
     * @description
     *      Get a bubble conversation by id
     * @param {String} conversationId Conversation id The conversation to clean
     * @return {Conversation} The conversation to retrieve
     */
    getConversationByBubbleDbId(bubbleDbId) {
        if (this.conversations) {
            for (var key in this.conversations) {
                if (this.conversations.hasOwnProperty(key) && this.conversations[key].bubble && this.conversations[key].bubble.dbId === bubbleDbId) {
