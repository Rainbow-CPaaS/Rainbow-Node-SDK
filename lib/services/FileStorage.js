...
class FileStorage {
     ...
     *    Return a promise
     * @return {buffer Binary data of the file type,  Mime type, fileSize: fileSize, Size of the file , fileName: fileName The name of the file } Return the file received
     */
