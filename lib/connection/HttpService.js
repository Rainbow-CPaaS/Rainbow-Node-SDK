...
class HTTPService {
    ...
    start() {
        ...
        return new Promise(function(resolve, reject) {
            that.logger.log("debug", LOG_ID + "start - Host", that._host);
    ...
    get(url, headers) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            that.logger.log("info", LOG_ID + "GET", url);
            ...
            request.end(function (response) {
                that.logger.log("info", LOG_ID + "GET", response.code);
    ...
    post(url, headers, data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            that.logger.log("info", LOG_ID + "POST", url, data);
            ...
            request.end(function (response) {
                that.logger.log("info", LOG_ID + "POST", response.code);
                if(response.code === 200) {
                    resolve(response.body);
                }
                else {
