    ...
    constructor(_xmpp, _im, _eventEmitter, _logger, _proxy) {
        ...
        handleXMPPConnection = () => {
            ...
            this.xmppClient.on(CONNECT_EVENT, function (msg) {
                that.logger.log("debug", LOG_ID + "(handleXMPPConnection) event - " + CONNECT_EVENT + " |" + msg);
            });
            ...
            this.xmppClient.on(DISCONNECT_EVENT, function (msg) {
                that.logger.log("debug", LOG_ID + "(handleXMPPConnection) event - " + DISCONNECT_EVENT + " |" + msg);
            });
            ...
            this.reconnect.on(RECONNECTING_EVENT, (msg) => {
                that.logger.log("debug", LOG_ID + "(handleXMPPConnection) plugin event - " + RECONNECTING_EVENT + " |" + msg);
            ...
            this.reconnect.on(RECONNECTED_EVENT, (msg) => {
                that.logger.log("debug", LOG_ID + "(handleXMPPConnection) plugin event - " + RECONNECTED_EVENT + " |" + msg);
            ...
            this.xmppClient.start({
                ...
                that.logger.log("started", jid.toString());
            }).catch(err => {
                ...
                that.logger.error("start failed", err);
            });
        };
    }
