        ...
        handleXMPPConnection = () => {
            ...
            this
                ...
                .on(ONLINE_EVENT, function (msg) {
                    ...
                    that
                        .logger
                        .log("info", LOG_ID + "(handleXMPPConnection) connected as " + msg.jid);
                    that
                        .eventEmitter
                    ...
                    switch (stanza.getName()) {
                        case "iq":
                            ...
                            children.forEach(function (node) {
                                switch (node.getName()) {
                                    case "ping":
                                        var stanzaResponse = new Client.Stanza("iq", {
