...
class XMPPService {
            ...
            this.xmppClient.on(STANZA_EVENT, function (stanza) {
                ...
                switch (stanza.getName()) {
                    ...
                    case "message":
                        ...
                        if (messageType === "chat" || messageType === "groupchat") {
                            ...
                            children.forEach(function (node) {
                                switch (node.getName()) {
                                    case "sent":
                                        that.logger.log("info", LOG_ID + "(handleXMPPConnection) message - carbon copy message sent received");
                                                ...
                                                if (childs) {
                                                    childs.forEach(function (nodeChild) {
                                                        if (nodeChild.getName() === "body") {
                                                            that.logger.log("info", LOG_ID + "(handleXMPPConnection) message - carbon copy chat message received ");
                                    ...
                                    case "request":
                                        {    
                                            ...
                                            //Acknowledge 'read'
                                        if (that.shouldSendReadReceipt || (messageType === "groupchat" && XMPPUtils.getResourceFromFullJID(stanza.attrs.from) === that.fullJid)) {
                            ...
                            if (hasATextMessage && ((messageType === "groupchat" && fromBubbleUserJid !== that.fullJid) || (messageType === "chat" && fromJid !== that.fullJid))) {
    ...
    sendChatMessage(message, jid, lang, content) {
        this
            .logger
    ...
    sendChatMessageToBubble(message, jid, lang, content) {
        this
            .logger
