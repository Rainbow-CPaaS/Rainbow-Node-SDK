        ...
        handleXMPPConnection = () => {
            ...
            this
                ...
                .on(ERROR_EVENT, function (err) {
                    ...
                    that
                        .logger
                        .log("error", LOG_ID + "(handleXMPPConnection) received", err);
                    that 
                        .eventEmitter
            ...
            this
                .xmppClient
                .on(DISCONNECT_EVENT, function (msg) {
                    that
                        .logger
            ...
            this
                ...
                .on(ERROR_EVENT, err => {
                    that
                        .logger
                        .log("debug", LOG_ID + "(handleXMPPConnection) event - error");
                    that
                        .logger
                        .log("info", LOG_ID + "(handleXMPPConnection) re-connection error", err);
                });
