...
class XMPPService {
    ...
    sendChatMessage(message, jid, lang) {
        ...
        if (this.useXMPP) {
            ...
            var stanza = new Client.Stanza("message", {"from": this.fullJid, "to": jid, "xmlns": "jabber:client", "type": "chat", "id":id}).c("body", { "xml:lang": lang }).t(message).up().c("request", { "xmlns": "urn:xmpp:receipts" }).up();
    ...
    sendChatMessageToBubble(message, jid, lang) {
        ...
        if (this.useXMPP) {
            ...
            var stanza = new Client.Stanza("message", {"to": jid, "type": "groupchat", "id":id}).c("body", { "xml:lang": lang }).t(message).up().c("request", { "xmlns": "urn:xmpp:receipts" }).up();
