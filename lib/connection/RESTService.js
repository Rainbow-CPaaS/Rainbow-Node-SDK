...
class RESTService {
    ...
    updateServerConversation (conversationId, mute) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.put("/api/rainbow/enduser/v1.0/users/" + that.account.id + "/conversations/" + conversationId, getRequestHeader(), {"mute": mute}).then(function(json) {
    ...
    sendConversationByEmail(conversationId) {
        ...
        return new Promise((resolve, reject) => {
            ...
            that.http.post("/api/rainbow/enduser/v1.0/users/" + that.account.id + "/conversations/" + conversationId + "/downloads", getRequestHeader()).then((json) => {
    ...
    ackAllMessages(conversationId) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.put("/api/rainbow/enduser/v1.0/users/" + that.account.id + "/conversations/" + conversationId + "/markallread", getRequestHeader()).then(function(json) {
