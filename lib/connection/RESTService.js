...
class RESTService {
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.put("/api/rainbow/enduser/v1.0/rooms/" + bubbleId, getRequestHeader(), { 
                visibility: visibility } 
                 ...
                 that.logger.log("info", LOG_ID + "(setBubbleVisibility) REST bubble created", json.data);
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.put("/api/rainbow/enduser/v1.0/rooms/" + bubbleId, getRequestHeader(), { 
                topic: topic } 
                 ...
                 that.logger.log("info", LOG_ID + "(setBubbleTopic) REST bubble created", json.data);
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.put("/api/rainbow/enduser/v1.0/rooms/" + bubbleId, getRequestHeader(), { 
                name: name } 
                 ...
                 that.logger.log("info", LOG_ID + "(setBubbleName) REST bubble created", json.data);
    ...
    getBubbles() {
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.get("/api/rainbow/enduser/v1.0/rooms?format=full&limit=300&userId=" + that.account.id, getRequestHeader()).then(function(json) {
