...
class RESTService {
    ...
    deleteChannel(channelId) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.delete("/api/rainbow/channels/v1.0/channels/" + channelId, getRequestHeader()).then(function(json) {
                 ...
                 that.logger.log("info", LOG_ID + "(deleteChannel) REST remove channelId", json.data);
    ...
    findChannels(title_substring, limit, offset, sortField, sortOrder) {
        var that = this;
                ...
                let query = "?title_substring=" + title_substring;
                if( limit ) {
                    query += "&limit=" + limit;
                }
                if( offset ) {
                ...
                return new Promise(function(resolve, reject) {
                    ...
                    that.http.get("/api/rainbow/channels/v1.0/channels/search" + query, getRequestHeader()).then(function(json) {
                         ...
                         that.logger.log("info", LOG_ID + "(findChannels) REST remove channelId", json.data);
    ...
    var that = this;
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.get("/api/rainbow/channels/v1.0/channels", getRequestHeader()).then(function(json) {
                ...
                that.logger.log("info", LOG_ID + "(getChannels) received " + JSON.stringify(json) + " channels");
    ...
    publishMessage( channelId, title, body) {
        let that = this;
                ...
                return new Promise(function(resolve, reject) {
                    ...
                    that.http.post("/api/rainbow/channels/v1.0/channels/" + channelId + "/publish", getRequestHeader(), payload).then(function(json) {
    ...
    subscribeToChannel( channelId) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.post("/api/rainbow/channels/v1.0/channels/" + channelId + "/subscribe", getRequestHeader(), payload).then(function(json) {
    ...
    unsubscribeToChannel( channelId) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.delete("/api/rainbow/channels/v1.0/channels/" + channelId + "/unsubscribe", getRequestHeader(), payload).then(function(json) {
    ...
    var that = this;
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.get("/api/rainbow/channels/v1.0/channels/" + channelId + "/users", getRequestHeader()).then(function(json) {
    ...
    updateChannelUsers(channeld, users) {
        var that = this;
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.put("/api/rainbow/channels/v1.0/channels/" + channelId + "/users", getRequestHeader(), users).then(function(json) {
                 that.logger.log("info", LOG_ID + "(updateChannelUsers) successfull");
                 that.logger.log("info", LOG_ID + "(updateChannelUsers) REST bubble updated topic", json.data);
