...
class RESTService {
    ...
    createCompany(name) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            that.http.post('/api/rainbow/admin/v1.0/companies', getRequestHeader(), {name: name}).then(function (json) {
    ...
    setVisibilityForCompany(companyId, visibleByCompanyId) {
        ...
        return new Promise(function (resolve, reject) {
            that.http.post('/api/rainbow/admin/v1.0/companies/' + companyId + "/visible-by/" + visibleByCompanyId, getRequestHeader()).then(function (json) {
    ...
    getServerProfiles() {
        ...
        return new Promise((resolve, reject) => {
            ...
            that.http.get("/api/rainbow/enduser/v1.0/users/" + that.account.id + "/profiles", getRequestHeader()).then(function(json) {
    ...
    getServerConversations() {
        ...
        return new Promise((resolve, reject) => {
            ...
            that.http.get("/api/rainbow/enduser/v1.0/users/" + that.account.id + "/conversations", getRequestHeader()).then(function(json) {
    ...
    createServerConversation ( conversation) {
        ...
        return new Promise((resolve, reject) => {
            ...
            that.http.post("/api/rainbow/enduser/v1.0/users/" + that.account.id + "/conversations", getRequestHeader(), conversation).then((json) => {
    ...
    deleteServerConversation (conversationId) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.delete("/api/rainbow/enduser/v1.0/users/" + that.account.id + "/conversations/" + conversationId, getRequestHeader()).then(function(json) {
    ...
    updateServerConversation (conversationId, mute) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.put("/api/rainbow/enduser/v1.0/users/" + that.account.id + "/conversation" + conversationId, getRequestHeader(), {"mute": mute}).then(function(json) {
    ...
    sendConversationByEmail(conversation) {
        ...
        return new Promise((resolve, reject) => {
            ...
            that.http.post("/api/rainbow/enduser/v1.0/users/" + that.account.id + "/conversations", conversation.dbId + "/downloads", getRequestHeader()).then((json) => {
    ...
    ackAllMessages(conversationId) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.put("/api/rainbow/enduser/v1.0/users/" + that.account.id + "/conversation" + conversationId + "/markallread", getRequestHeader(), {"data": users}).then(function(json) {
