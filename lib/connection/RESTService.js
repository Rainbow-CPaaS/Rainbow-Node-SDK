...
class RESTService {
    ...
    deleteUser(userId) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            that.http.delete("/api/rainbow/admin/v1.0/users/" + userId, that.getRequestHeader()).then(function(json) {
                ...
                that.logger.log("internal", LOG_ID + "(deleteUser) REST admin delete user", json.data);
    ...
    reconnect() {
        ...
        return new Promise((resolve, reject) => {
            ...
            that.eventEmitter.removeListener("attempt_succeeded", null);
            ...
            that.eventEmitter.removeListener("attempt_failed");
