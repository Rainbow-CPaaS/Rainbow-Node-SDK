    ...
    releaseCall(requestHeader, call) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (call.connectionId) {
                ...
                var error = ErrorCase.OTHERERROR('can not release call', 'no connectionId found in call ' + JSON.stringify(call));// errorHelperService.handleError(response);
                reject(error);
    ...
    answerCall(requestHeader, call) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (call) {
                ...
                var error = ErrorCase.OTHERERROR('can not answerCall call', 'answerCall for call ' + JSON.stringify(call));// errorHelperService.handleError(response);
                reject(error);
    ...
    holdCall(requestHeader, call) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (call) {
                ...
                var error = ErrorCase.OTHERERROR('can not holdCall call', 'holdCall for call ' + JSON.stringify(call));// errorHelperService.handleError(response);
                reject(error);
                that._logger.log("error", LOG_ID + "(answerCall) ", error);
            }
        });
    ...
    retrieveCall(requestHeader, call) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (call) {
                ...
                var error = ErrorCase.OTHERERROR('can not retrieveCall call', 'retrieveCall for call ' + JSON.stringify(call));// errorHelperService.handleError(response);
                reject(error);
    ...
    deflectCallToVM(requestHeader, call, VMInfos) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (call) {
                ...
                var error = ErrorCase.OTHERERROR('can not deflectCallToVM call', 'deflectCallToVM for call ' + JSON.stringify(call));// errorHelperService.handleError(response);
                reject(error);
    ...
    transfertCall(requestHeader, activeCall, heldCall) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (call) {
                ...
                var error = ErrorCase.OTHERERROR('can not transfertCall call', 'transfertCall for call ' + JSON.stringify(call));// errorHelperService.handleError(response);
                reject(error);
    ...
    conferenceCall(requestHeader, activeCall, heldCall) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (call) {
                ...
                var error = ErrorCase.OTHERERROR('can not conferenceCall call', 'conferenceCall for call ' + JSON.stringify(call));// errorHelperService.handleError(response);
                reject(error);
