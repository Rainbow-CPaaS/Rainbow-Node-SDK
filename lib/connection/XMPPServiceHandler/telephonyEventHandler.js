                            ...
                            return contactService.getOrCreateContact(jid, phoneNumber)
                                .then(function (contact) {
                                    if (contact.temp) { //not a rainbow user
                                        ...
                                        if (call.contact && call.contact.id) {	//not a conf
                                            let currentCalled = {contactPhoneNumber: phoneNumber, contact: contact};
                                            if (call.contact.id !== contact.id || call.contact.displayName === phoneNumber || call.contact.getNameUpdatePrio() === NameUpdatePrio.OUTLOOK_UPDATE_PRIO) {
                                        ...
                                        if (call.contact && call.contact.id) {	//not a conf
                                            let currentCalled = {contactPhoneNumber: phoneNumber, contact: contact};
                                            if (call.contact.id !== contact.id) {//update call.contact if not the good one
