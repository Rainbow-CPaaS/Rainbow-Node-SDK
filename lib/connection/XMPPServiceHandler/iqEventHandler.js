...
class IQEventHandler extends GenericHandler {
    ...
    constructor(xmppService) {
            ...
            children.forEach((node) => {
                switch (node.getName()) {
                    ...
                    default:
                        that
                            .logger
                            .log("warn", LOG_ID + "(handleXMPPConnection, onIqGetReceived) child not managed for iq - 'stanza'", node.getName());
                }
            });
        };
        ...
        that._onIqGetPbxAgentStatusReceived = (stanza, node) => {
            ...
            that
                .logger
                .log("info", LOG_ID + "(handleXMPPConnection) _onIqGetPbxAgentStatusReceived - 'pbxagentstatus'", pbxagentstatus.toString());
