...
class Options {
    ...
    parse() {
        ...
        this._withXMPP = mode === "xmpp" ? true : false;
        this._CLIMode = mode === "cli" ? true : false;
    }
    ...
    _getHTTPOptions() {
        ...
        switch (this._options.rainbow.host) {
            ...
            case "sandbox":
                ...
                break;
            default:
                this._logger.log("warn", LOG_ID + "(constructor) 'host' property is not valid (should be 'sandbox' or 'official'). Use 'sandbox'", this._options.rainbow.host);
                break;
        }
        return httpOptions;
    }
