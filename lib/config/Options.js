    ...
    _getXMPPOptions() {
        ...
        switch (this._options.rainbow.host) {
            ...
            default:
                ...
                if ( this._options.xmpp.protocol ) { xmppOptions.protocol = this._options.xmpp.protocol; }
                if ( this._options.xmpp.port) { xmppOptions.port = this._options.xmpp.port; }
                this._logger.error(JSON.stringify(xmppOptions));
